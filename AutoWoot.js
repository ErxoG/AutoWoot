 ...
 * @author  Thedark1337
 *
 * @version 5.0.0-release.11
 *
 * @license Copyright © 2012-2020 The plug³ Team and other contributors
...
;(function loading() {
    ...
    if (isLoaded()) {
        ...
        require.config({
            paths:{
                sentry: [
                    'https://browser.sentry-cdn.com/5.15.4/bundle.min',
                    'https://api.plugcubed.net/sentry'
                ]
            }
        });
...
define('plugCubed/Settings',['plugCubed/Class', 'plugCubed/Utils', 'plugCubed/Lang', 'plugCubed/StyleManager'], function(Class, p3Utils, p3Lang, Styles) {
    var names = [];
    var curVersion;
...
define('plugCubed/RoomSettings',['jquery', 'underscore', 'plugCubed/Class', 'plugCubed/Utils', 'plugCubed/Lang', 'plugCubed/StyleManager', 'plugCubed/Settings'], function($, _, Class, p3Utils, p3Lang, Styles, Settings) {
    ...
    var Context, RoomModel, Handler, showMessage, oriLang, Lang, langKeys, ranks, that;
...
define('plugCubed/dialogs/ControlPanel',['jquery', 'underscore', 'plugCubed/Class', 'plugCubed/Utils', 'plugCubed/Lang'], function($, _, Class, p3Utils, p3Lang) {
    ...
    ControlPanelClass = Class.extend({
        ...
        onResize: function() {
            ...
            var $innerPanel = $('#playlist-panel #media-panel .jspPane');
            ...
            $controlPanelDiv.find('.jspContainer').width($innerPanel.width());
            $controlPanelDiv.find('.jspPane').width($innerPanel.width());
...
define('plugCubed/handlers/CommandHandler',['plugCubed/handlers/TriggerHandler', 'plugCubed/Utils', 'plugCubed/Lang', 'plugCubed/dialogs/Commands', 'plugCubed/Settings', 'plugCubed/Version', 'plugCubed/StyleManager'], function(TriggerHandler, p3Utils, p3Lang, dialogCommands, Settings, Version, StyleManager) {
...
define('plugCubed/handlers/HideVideoHandler',['jquery', 'plugCubed/Class', 'plugCubed/Lang', 'plugCubed/Settings', 'plugCubed/dialogs/Menu', 'plugCubed/Utils'], function($, Class, p3Lang, Settings, Menu, p3Utils) {
...
define('plugCubed/features/Automute',['plugCubed/handlers/TriggerHandler', 'plugCubed/Settings', 'plugCubed/Lang'], function(TriggerHandler, Settings, p3Lang) {
    var Handler = TriggerHandler.extend({
        trigger: 'advance',
        handler: function(data) {
...
define('plugCubed/features/Autorespond',['plugCubed/handlers/TriggerHandler', 'plugCubed/Lang', 'plugCubed/Settings', 'plugCubed/RoomSettings', 'plugCubed/Utils', 'plugCubed/dialogs/Menu'], function(TriggerHandler, p3Lang, Settings, RoomSettings, p3Utils, Menu) {
    var Lang, Handler;
...
define('plugCubed/overrides/RoomUserListRow',['jquery', 'plugCubed/Utils', 'plugCubed/RoomSettings', 'lang/Lang'], function($, p3Utils, RoomSettings, Lang) {
...
define('plugCubed/overrides/UserRolloverView',['jquery', 'plugCubed/handlers/OverrideHandler', 'plugCubed/Utils', 'plugCubed/Lang', 'lang/Lang'], function($, OverrideHandler, p3Utils, p3Lang, Lang) {
...
define('plugCubed/Loader',['module', 'plugCubed/Class', 'plugCubed/Notifications', 'plugCubed/Version', 'plugCubed/StyleManager', 'plugCubed/Settings', 'plugCubed/Lang', 'plugCubed/Utils',
    ...
    return Loader;
        ...
        require(['plugCubed/Loader', 'sentry', 'plugCubed/Version'], function(Loader, Sentry, Version) {
            if (typeof Sentry !== 'undefined') {
                Sentry.config('https://a0f31a6f42e14b42a0eb5383f1bf7647@sentry.tfle.xyz/5', {
                    debug: true,
                    ignoreErrors: [
                        'adsbygoogle',
                        'bscbot',
